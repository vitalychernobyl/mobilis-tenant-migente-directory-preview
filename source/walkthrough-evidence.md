...
- Reviewed records source: [tenant/data/directory/reviewed-records.yaml](https://github.com/vitalychernobyl/mobilis-tenant-migente/blob/main/tenant/data/directory/reviewed-records.yaml)
- Source/display policy: [tenant/docs/directory/source-and-display-policy.md](https://github.com/vitalychernobyl/mobilis-tenant-migente/blob/main/tenant/docs/directory/source-and-display-policy.md)
...
|---|---|---|
| Hosted preview returns HTTP 200 | Passed | [Mi Gente directory static preview](https://vitalychernobyl.github.io/mobilis-tenant-migente-directory-preview/) |
