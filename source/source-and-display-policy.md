...
This policy defines which sources Mi Gente can use for the first directory launch and which fields can be shown publicly. It applies to classes, studios, instructors, and directory taxonomy in [`tenant/data/directory`](../../data/directory/).
...
- [`tenant/capabilities/marketplace-app.yaml`](../../capabilities/marketplace-app.yaml)
- [`tenant/data/directory/README.md`](../../data/directory/)
- [`tenant/docs/directory/README.md`](README.md)
- [`tenant/launch/migente-directory-static-site-mvp/release-evidence.md`](../../launch/migente-directory-static-site-mvp/release-evidence.md)
